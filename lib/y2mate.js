...
async function yt(url, quality, type, bitrate, server = 'en68') {
    ...
    let res = await post(`https://ytdownloadid.herokuapp.com/mates/${server}/analyze/ajax`, {
        url,
        q_auto: 0,
        ajax: 1
    })
    ...
    let res2 = await post(`https://ytdownloadid.herokuapp.com/mates/${server}/convert`, {
        type: 'youtube',
        _id: id[1],
        v_id: ytId[1],
        ajax: '1',
